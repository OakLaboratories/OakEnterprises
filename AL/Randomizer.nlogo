to toss-a-coin
  repeat checks [
    let flip random 2
    ifelse flip = 0 [ask turtles [set shape "coin heads"]] 
    [ask turtles [set shape "coin tails"]]
    wait 0.3]
end
...
to roll-a-die
  repeat checks [
    let roll random 6
    ifelse roll = 0 [ask turtles [set shape "die 1"]]
    [ifelse roll = 1 [ask turtles [set shape "die 2"]]
      [ifelse roll = 2 [ask turtles [set shape "die 3"]]
        [ifelse roll = 3 [ask turtles [set shape "die 4"]]
          [ifelse roll = 4 [ask turtles [set shape "die 5"]]
