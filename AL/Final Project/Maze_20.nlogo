...
players-own [juicestate health speed strength]
...
to go_3
  ;Power-ups
    while [text_state = 0 ] [
  set text "What's this?!!...  Giant chess pieces? I'm getting deja-vu."
  wait 7
...
to go_5boss
 ...
 ask players [if [pcolor] of patch-here = yellow [set pcolor one-of [4 34]
  ...
  if count bosses = 0 [set text "I've been defeated!" wait 2
    set text "I forever curse the rats who did this to me" wait 2 set level 6 set change? true]
end
;-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
to setup_6boss
  ca
...
if alieninterstate = 4 [
  set alienboss_state 1 ]

while [ alienboss_state = 1] [
...
ask players [if [pcolor] of patch-here = 24 and alienboss_state = 1.5 and alieninterstate = 4 [ set alieninterstate 5 set music_state 1]]
...
ask players [if [pcolor] of patch-here = green and alienboss_state = 1.5 and alieninterstate = 8 [ set alieninterstate 9 set music_state 1]]
  ask players [if [pcolor] of patch-here = 24 and alienboss_state = 1.5 and alieninterstate = 9 [ set alieninterstate 10 set music_state 1]]
  ask players [if [pcolor] of patch-here = yellow and alienboss_state = 1.5 and alieninterstate = 10 [ set alieninterstate 11 set music_state 1]]
  ask players [if [pcolor] of patch-here = blue and alienboss_state = 1.5 and alieninterstate = 11 [ set alieninterstate 12 set music_state 1]]
if alieninterstate = 12 [
  set alienboss_state 3 ]
...
false
2
Circle -955883 true true 111 14 78
Polygon -7500403 true false 110 68 190 66 152 118
Polygon -7500403 true false 199 92 244 152 229 182 169 107
Polygon -16777216 true false 229 244 204 159 239 102 241 104 265 137 267 155 230 242
Polygon -7500403 true false 112 95 127 200 92 278 107 293 137 293 157 230 167 293 197 293 212 278 187 200 202 95
Rectangle -7500403 true false 127 84 172 99
Polygon -7500403 true false 112 93 67 153 82 183 142 108
Polygon -16777216 true false 105 30 150 30
Polygon -7500403 true false 109 42 144 42 146 57 150 57 152 43 190 44 182 27 175 20 169 16 156 13 146 11 134 16 124 20 118 24 112 33 111 41
Polygon -16777216 true false 75 178 75 193 87 196 100 189 100 176 87 172 75 152 90 145 84 135 68 146 17 50 -4 45 -3 63 56 152 41 159 52 167 64 161 76 180
Polygon -7500403 true false 73 184 73 199 85 202 98 195 98 182 85 178 73 158 88 151 82 141 66 152 15 56 -6 51 -5 69 54 158 39 165 50 173 62 167 74 186
Polygon -7500403 true false 243 242 215 162 253 100 255 102 279 135 281 153 245 246
Polygon -1184463 true false 247 238 220 162 254 107 255 108 276 140 275 154 244 236
Circle -16777216 true false 231 136 36
Circle -1184463 true false 238 143 22
Polygon -1184463 true false 112 92 193 90 195 143 186 202 127 203 117 137 113 94
Circle -16777216 true false 132 106 46
Circle -1184463 true false 140 114 30
Circle -16777216 true false 129 49 10
Circle -16777216 true false 129 49 10
Circle -16777216 true false 159 49 10
Polygon -1184463 true false 139 34 141 37
...
true
0
Polygon -7500403 true true 210 225 240 225 240 195 225 150 225 135 240 105 255 60 240 45 240 15 210 0 180 0 165 15 60 30 45 45 45 60 45 60 60 75 75 90 120 90 90 120 75 165 75 180 90 225
Circle -16777216 true false 142 33 24
Line -16777216 false 197 19 192 30
Line -16777216 false 220 26 212 34
Line -16777216 false 239 38 230 43
Line -16777216 false 251 60 236 60
Line -16777216 false 247 85 233 83
Line -16777216 false 237 111 231 108
Line -16777216 false 229 133 223 130
Polygon -7500403 true true 240 225 255 240 300 255 300 255 240 270 75 270 60 240 90 225
Polygon -7500403 true true 165 270 150 285 150 300 165 300 165 285 180 270
Polygon -7500403 true true 120 270 105 285 105 300 120 300 120 285 135 270
Polygon -7500403 true true 90 135 75 150 45 150 45 135 75 135 90 120
Polygon -7500403 true true 90 165 75 180 45 180 45 165 75 165 90 150
