...
to attack_fast
  ...
  if any? x [
    wait .05
    ask min-one-of x [distance myself] [set health health - 4]
  ]
  let y enemies in-radius 3 with [species = "fast"]
  if any? y [
    wait .05
    ask min-one-of y [distance myself] [set health health - 2]
  ]
  let z enemies in-radius 3 with [species = "long-range"]
  if any? z [
    wait .05
    ask min-one-of z [distance myself] [set health health - 1]
  ]
end
...
to attack_strong
  ...
  if any? x [
    wait .1
    ask min-one-of x [distance myself] [set health health - 8]
  ]
  let y enemies in-radius 3 with [species = "strong"]
  if any? y [
    wait .1
    ask min-one-of y [distance myself] [set health health - 4]
  ]
  let z enemies in-radius 3 with [species = "fast"]
  if any? z [
    wait .1
    ask min-one-of z [distance myself] [set health health - 2]
  ]
end
...
to create-power-ups
  if power-up-state < 4 and 1 > random 100 [
