...
to setup_4
  ...
  set text_state 0
  set text "    "
  import-pcolors "Map Industry.png"
...
to setup_5
  ...
  set text_state 0
  set text "    "
  import-pcolors "Map 5 modern.png"
  ask patches with [pcolor = white] [set pcolor 16.6]
  ask patch 11 11 [set pcolor 72.5]
...
true
0
Polygon -7500403 true true 210 225 240 225 240 195 225 150 225 135 240 105 255 60 240 45 240 15 210 0 180 0 165 15 60 30 45 45 45 60 60 75 75 90 120 90 90 120 75 165 75 180 90 225
...
Polygon -7500403 true true 240 225 255 240 300 255 240 270 75 270 60 240 90 225
