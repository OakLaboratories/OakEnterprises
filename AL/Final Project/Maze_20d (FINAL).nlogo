...
to setup
  ...
  wait 5
  set text "TURN ON YOUR SOUND AND MAKE SURE YOU HAVE A WORKING MOUSE/KEYBOARD"
  wait 5
  setup_1
end
...
while [alienboss_state = 0 and text_state = 1] [
  wait 1
...
ask players [if [pcolor] of patch-here = yellow and alienboss_state = .5 and alieninterstate = 0 [ setxy -7 -7 set alieninterstate 1 set music_state 1]]

  ask players [if [pcolor] of patch-here = blue and alienboss_state = .5 and alieninterstate = 1 [ setxy -7 -7 set alieninterstate 2 set music_state 1]]
  ask players [if [pcolor] of patch-here != blue and [pcolor] of patch-here != 12 and [pcolor] of patch-here != 15 and alienboss_state = .5 and alieninterstate = 1 [ set alieninterstate 0 set music_state 1]]
  
  ask players [if [pcolor] of patch-here = green and alienboss_state = .5 and alieninterstate = 2 [ setxy -7 -7 set alieninterstate 3 set music_state 1]]
   ask players [if [pcolor] of patch-here != green and [pcolor] of patch-here != 12 and [pcolor] of patch-here != 15 and alienboss_state = .5 and alieninterstate = 2 [ set alieninterstate 0 set music_state 1]]
   
   
  ask players [if [pcolor] of patch-here = 24 and alienboss_state = .5 and alieninterstate = 3 [ setxy -7 -7 set alieninterstate 4 set music_state 1]]
  ask players [if [pcolor] of patch-here != 24 and [pcolor] of patch-here != 12 and [pcolor] of patch-here != 15 and alienboss_state = .5 and alieninterstate = 3 [ set alieninterstate 0 set music_state 1]]
...
ask players [if [pcolor] of patch-here = 24 and alienboss_state = 1.5 and alieninterstate = 4.5 [ setxy -7 -7 set alieninterstate 5 set music_state 1]]

  ask players [if [pcolor] of patch-here = blue and alienboss_state = 1.5 and alieninterstate = 5 [setxy -7 -7 set alieninterstate 6 set music_state 1]]
  ask players [if [pcolor] of patch-here != blue and [pcolor] of patch-here != 12 and [pcolor] of patch-here != 15 and alienboss_state = 1.5 and alieninterstate = 5 [ set alieninterstate 4.5 set music_state 1]]
  
  ask players [if [pcolor] of patch-here = green and alienboss_state = 1.5 and alieninterstate = 6 [ setxy -7 -7 set alieninterstate 7 set music_state 1]]
  ask players [if [pcolor] of patch-here != green and [pcolor] of patch-here != 12 and [pcolor] of patch-here != 15 and alienboss_state = 1.5 and alieninterstate = 6 [ set alieninterstate 4.5 set music_state 1]]
  
  ask players [if [pcolor] of patch-here = yellow and alienboss_state = 1.5 and alieninterstate = 7 [setxy -7 -7 set alieninterstate 8 set music_state 1]]
  ask players [if [pcolor] of patch-here != yellow and [pcolor] of patch-here != 12 and [pcolor] of patch-here != 15 and alienboss_state = 1.5 and alieninterstate = 7 [ set alieninterstate 4.5 set music_state 1]]
...
ask players [if [pcolor] of patch-here = green and alienboss_state = 2.5 and alieninterstate = 8.5 [ setxy -7 -7 set alieninterstate 9 set music_state 1]]

  ask players [if [pcolor] of patch-here = 24 and alienboss_state = 2.5 and alieninterstate = 9 [ setxy -7 -7 set alieninterstate 10 set music_state 1]]
  ask players [if [pcolor] of patch-here != 24 and [pcolor] of patch-here != 12 and [pcolor] of patch-here != 15 and alienboss_state = 2.5 and alieninterstate = 9 [ set alieninterstate 8.5 set music_state 1]]
  
  ask players [if [pcolor] of patch-here = yellow and alienboss_state = 2.5 and alieninterstate = 10 [ setxy -7 -7 set alieninterstate 11 set music_state 1]]
  ask players [if [pcolor] of patch-here != yellow and [pcolor] of patch-here != 12 and [pcolor] of patch-here != 15 and alienboss_state = 2.5 and alieninterstate = 10 [ set alieninterstate 8.5 set music_state 1]]
  
  ask players [if [pcolor] of patch-here = blue and alienboss_state = 2.5 and alieninterstate = 11 [ setxy -7 -7 set alieninterstate 12 set music_state 1]]
  ask players [if [pcolor] of patch-here != blue and [pcolor] of patch-here != 12 and [pcolor] of patch-here != 15 and alienboss_state = 2.5 and alieninterstate = 11 [ set alieninterstate 8.5 set music_state 1]]
...
to go_8boss
 ...
 ; if count enemies < 12 
  ...
  if time-piece = "hamburger" [
   ...
   if text_state = 8 [set textval "I became an !alien! during the apocalypse" ]
...
A Maze of Historic Proportions is a history-themed adventure/strategy game with 8 levels and 8 bosses.
...
There are three different attack buttons, and three different kinds of enemy.  Pick which attack is most suited for each enemy.

## FOR MORE INFORMATION AND TIPS

View the Companion Guide, available in the folder.
@#$#@#$#@
default
true
0
